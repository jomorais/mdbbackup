...
def get_service(api_name, api_version, scopes, service_account_key):
...
def main():
    ...
    try:
        ...
        if option == 3:
            ...
            parent_folder = input(
                'Enter parent folder in drive (enter to upload to root): ')
            if parent_folder:
        ...
        if option == 6:
            ...
            parent_folder = input(
                'Enter parent folder for new file (enter to same folder): ')
